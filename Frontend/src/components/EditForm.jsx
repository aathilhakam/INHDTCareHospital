  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Redirect to DonorDetailsTable after successful update
        navigate('/DonorDetailsTable', { state: { successMessage: 'Donor updated successfully!' } });
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-100 via-gray-100 to-white py-12 px-4">
      ...
      <div className="max-w-2xl mx-auto">
        {/* Hero Section */}
        <div className="text-center mb-10 bg-gradient-to-r from-blue-400 to-blue-600 text-white py-8 px-6 rounded-xl shadow-lg">
          <h1 className="text-3xl font-bold mb-2">
            Edit Donor Information
          </h1>
          <p className="text-xl opacity-90">Update donor details below</p>
        </div>

        {/* Edit Form */}
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-2 border-blue-600">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full p-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 appearance-none bg-white"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    pattern="07\d{8}"
                    className="w-full p-3 pl-14 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
            ...
            <div className="pt-6 flex space-x-4">
              <button
                ...
                className="flex-1 py-3 px-6 rounded-xl font-bold text-white bg-gray-600 hover:bg-gray-700 shadow-lg hover:shadow-xl transition-all"
              >
                Cancel
              </button>
              <button
                ...
                className={`flex-1 py-3 px-6 rounded-xl font-bold text-white transition-all ${
                  isSubmitting ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-xl'
                }`}
              >
                {isSubmitting ? (
